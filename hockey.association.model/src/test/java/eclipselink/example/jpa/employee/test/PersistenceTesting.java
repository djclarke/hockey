...
import hockey.model.persistence.PersistenceHelper;
...
public class PersistenceTesting {
    ...
    public static EntityManagerFactory createEMF(boolean replaceTables) {
        ...
        setProperty(props, PersistenceUnitProperties.JDBC_URL, "jdbc:derby:target/derby/hockey;create=true");
        ...
        return PersistenceHelper.createEMF(props);
    }
